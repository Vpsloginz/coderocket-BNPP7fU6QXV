  ...
  const testimonials = [
    {
      ...
      content: "Spartanox has transformed my trading experience. The platform is incredibly user-friendly, and the execution speed is unmatched. I've seen significant improvements in my trading performance since switching to their ECN account.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The educational resources and market analysis provided by Spartanox are exceptional. Their customer support team is always available when I need assistance, and the trading conditions are among the best in the industry.",
      rating: 5,
    ...
    },
    {
      name: "Sarah Chen",
      role: "Day Trader",
      content: "I've been trading with Spartanox for over 2 years now. The tight spreads and fast execution have helped me maximize my profits. The mobile app is fantastic for trading on the go.",
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from successful traders who have chosen Spartanox as their trusted trading partner
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#aeff1c] to-[#9ee619] rounded-3xl p-12 text-center">
          ...
          <p className="text-lg text-gray-800 mb-8 max-w-2xl mx-auto">
            Join thousands of successful traders and experience the difference with Spartanox
          </p>
